 BEGIN TRY 
 Drop Procedure dbo.[Print_GenkaCSV_20210622_bak]
END try
...
-- =============================================
CREATE PROCEDURE [dbo].[Print_GenkaCSV_20210622_bak]
...
BEGIN
	...
	DECLARE @loopcount INT, @count as int, @rowcount INT, @a_count INT, @s20_count INT, @o_count INT, @b_count INT, @t_count INT, @minid INT, @maxid INT, @prjCD VARCHAR(10), @hinbanCD VARCHAR(10);
