 BEGIN TRY 
 Drop Procedure dbo.[M_Contrl_YearMonth_Genka_Update]
END try
...
GO
 ...
 --=============================================
CREATE PROCEDURE [dbo].[M_Contrl_YearMonth_Genka_Update] 
...
BEGIN
  ...
  Group by LEFT(d.CostDate,4),d.CostCD,d.ProjectCD,d.HinbanCD,d.BrandCD,d.Season,d.Year,d.CastingCD,d.FreeItem1,con.FiscalYYYYMM,keihi.Accounting
   ...
   --(hin.Production * hin.SalesPrice) AS [Value],
   hinn.TotalValue,
   Round(Cast(hin.Production * hin.SalesPrice as decimal) / Cast(hinn.TotalValue as decimal),4) as [percentage], --SYPK ENo.191
   0
...
Group By con.FiscalYYYYMM,[HinbanCD],hin.FreeItem2,(CONVERT(bigint,hin.Production) * CONVERT(money,hin.SalesPrice)),hinn.TotalFreeItem2,hin.ProjectCD
